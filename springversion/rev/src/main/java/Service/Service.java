...
public class Service {
	...
	public int money(AreaVO input) {
		...
		// 각 테이블 바탕으로 예측값 산출
		int pv_np = dao.search(tb_nightplace);
		int pv_food = dao.search(tb_food);
		int pv_goal = dao.search(tb_goal);
		...
		System.out.println(tb_nightplace);
		System.out.println(tb_goal);
		System.out.println(tb_food);
